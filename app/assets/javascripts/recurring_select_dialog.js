(function() {
  ...
  window.RecurringSelectDialog = RecurringSelectDialog = (function() {
    function RecurringSelectDialog(_at_recurring_selector) {
      this.recurring_selector = _at_recurring_selector;
    ...
    RecurringSelectDialog.prototype.init_calendar_weeks = function(section) {
      ...
      for (index = _i = 0, _len = _ref.length; _i < _len; index = ++_i) {
        ...
        if (show_row[index]) {
          ...
          for (day_of_week = _j = _ref1 = $.fn.recurring_select.texts["first_day_of_week"], _ref2 = 7 + $.fn.recurring_select.texts["first_day_of_week"]; _ref1 <= _ref2 ? _j < _ref2 : _j > _ref2; day_of_week = _ref1 <= _ref2 ? ++_j : --_j) {
